...
class Score:
    ...
    def prep_level(self):
        """Преобразует уровень в графическое изображениe."""
    ...
    def show_score(self):
        """Выводит очки, рекорд и число оставшихся самолетов."""
